...
namespace BookStore
{
    public partial class AdminBook : Form
    {
       ...
       /* 
        ...
        private void textBoxBookPicture_Enter(object sender, EventArgs e)
        {
            if (textBoxBookPicture.Text == "Enter Book Picture")
            {
                textBoxBookPicture.Text = "";
            }
        }

        private void textBoxBookPicture_Leave(object sender, EventArgs e)
        {
            if (textBoxBookPicture.Text == "")
            {
