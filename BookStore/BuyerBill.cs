...
namespace BookStore
{
    public partial class BuyerBill : Form
    {
        public BuyerBill()
        {
            InitializeComponent();
        ...
        private void labelBillingDetails_Click(object sender, EventArgs e)
        {
        ...
        private void labelBillD_Click(object sender, EventArgs e)
        {
        ...
        private void BuyerBill_Load(object sender, EventArgs e)
        {
            // labelCurrentUser.Text = User_login.Username;
            DisplayBooks();
